...
/**
 * Exception thrown by Service layer classes when business logic operations fail. This exception
 * encapsulates service-specific errors with a standardized error code.
 *
 * <p>Usage: - When auction service operations fail (create, update, close auction) - When bid
 * service operations fail (place bid, validate bid) - When user service operations fail (deposit,
 * withdrawal)
 */
