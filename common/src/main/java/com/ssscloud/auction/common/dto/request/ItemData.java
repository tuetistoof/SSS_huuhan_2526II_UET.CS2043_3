...
public class ItemData implements Serializable {
    ...
    public void      setHasCertificate(boolean b)        { this.hasCertificate = b; }
 
    public boolean   isRepaired()                        { return isRepaired; }
    public void      setIsRepaired(boolean b)            { this.isRepaired = b; }
 
    public int       getWarrantyPeriod()                 { return warrantyPeriod; }
    public void      setWarrantyPeriod(int w)            { this.warrantyPeriod = w; }
