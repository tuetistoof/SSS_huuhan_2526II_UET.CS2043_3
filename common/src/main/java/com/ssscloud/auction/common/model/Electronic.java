...
public class Electronic extends Item {
    ...
    public Electronic (String name, String sellerId, long basePrice, LocalDate manufacturingDate,String creator, String description, boolean isRepaired, int warrantyPeriod){        
        super(name, sellerId, basePrice, manufacturingDate, creator, description);
        this.isRepaired = isRepaired;
        this.purchaseDate = null;
        this.warrantyPeriod = warrantyPeriod;
    }
    public Electronic (String id, String name, String sellerId, long basePrice, LocalDate manufacturingDate,String creator, String description, boolean isRepaired, LocalDate purchaseDate, int warrantyPeriod){        
