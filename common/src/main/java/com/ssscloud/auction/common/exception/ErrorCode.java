...
/**
 * Centralized management of all system error codes. Helps avoid typos when using error codes
 * throughout the codebase. Use IDE auto-complete to select error codes safely.
 */
public class ErrorCode {
  ...
  public static final String NOTIFICATION_SERVICE_NOT_INITIALIZED =
      "NOTIFICATION_SERVICE_NOT_INITIALIZED";
