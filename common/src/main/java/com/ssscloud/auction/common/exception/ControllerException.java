...
/**
 * Exception thrown by Controller layer classes when request validation or processing fails. This
 * exception encapsulates controller-specific errors with a standardized error code.
 *
 * <p>Usage: - When request validation fails (invalid parameters, missing fields) - When request
 * mapping fails (malformed JSON, type mismatch) - When controller-level authorization checks fail
 */
